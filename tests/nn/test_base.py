...
class TestLogEig:
    ...
    def test_forward_shape(self, n_matrices, n_features, use_autograd, device, dtype, generator):
        ...
        X = random_SPD(n_features, n_matrices, device=device, dtype=dtype, generator=generator)
    ...
    @pytest.mark.parametrize("n_matrices, n_features", [(1, 100), (50, 100)])
    @pytest.mark.parametrize("use_autograd", [True, False])
    def test_forward_output_symmetric(self, n_matrices, n_features, use_autograd, device, dtype, generator):
    ...
    def test_both_modes_give_same_gradient(self, n_matrices, n_features, device, dtype, generator):
        ...
        X1 = random_SPD(n_features, n_matrices, device=device, dtype=dtype, generator=generator)
        X2 = X1.clone()

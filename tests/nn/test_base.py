...
class TestStiefelProjectionPolarParametrization:
    ...
    def test_forward_shape(self, n_in, n_out, use_autograd, device, dtype, generator):
        ...
        Test that forward pass returns correct shape
        """
        layer = nn_spd_base.StiefelProjectionPolarParametrization(
    ...
    def test_both_modes_give_same_result(self, n_in, n_out, device, dtype, generator):
        ...
        layer_autograd = nn_spd_base.StiefelProjectionPolarParametrization(
            use_autograd=True
        )
        layer_manual = nn_spd_base.StiefelProjectionPolarParametrization(
            use_autograd=False
        )
...
class TestStiefelProjectionQRParametrization:
    ...
    def test_forward_shape(self, n_in, n_out, use_autograd, device, dtype, generator):
        ...
        Test that forward pass returns correct shape
        """
        layer = nn_spd_base.StiefelProjectionQRParametrization(
            use_autograd=use_autograd
        )
        weight = torch.randn(
            (n_in, n_out), device=device, dtype=dtype, generator=generator
    ...
    def test_both_modes_give_same_result(self, n_in, n_out, device, dtype, generator):
        ...
        layer_autograd = nn_spd_base.StiefelProjectionQRParametrization(
            use_autograd=True
        )
        layer_manual = nn_spd_base.StiefelProjectionQRParametrization(
            use_autograd=False
        )
...
class TestBiMap:
    ...
    @pytest.mark.parametrize(
        "parametrization",
        [
            nn_spd_base.StiefelProjectionPolarParametrization,
            nn_spd_base.StiefelProjectionQRParametrization,
    ...
    def test_backward_pass(
        ...
        """
        if (parametrization is nn_spd_base.StiefelProjectionPolarParametrization) and (

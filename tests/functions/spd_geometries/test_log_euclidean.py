...
class TestLogEuclideanLogCoordinates:
    """
    ...
    def test_forward_shape(
        ...
        X_auto = log_euclidean.log_euclidean_log_coordinates(data, reference_point)
        X_manual = log_euclidean.LogEuclideanLogCoordinates(data, reference_point)
        ...
        assert_close(
            log_euclidean.log_euclidean_exp_coordinates(X_auto, reference_point),
            data,
        )
        assert_close(
            log_euclidean.log_euclidean_exp_coordinates(X_manual, reference_point),
            data,
        )
    ...
    def test_self_log(self, n_features, cond, device, dtype, generator):
        ...
        X_manual = log_euclidean.LogEuclideanLogCoordinates(
            reference_point, reference_point
        )
        X_auto = log_euclidean.log_euclidean_log_coordinates(
            reference_point, reference_point
        )
    ...
    def test_general_case(self, n_matrices, n_features, cond, device, dtype, generator):
        ...
        reference_point_logm = spd_linalg.logm_SPD(reference_point)[0]
        tangent_vectors = spd_linalg.symmetrize(
            torch.squeeze(
                torch.randn(
                    (n_matrices, n_features, n_features),
        ...
        data = spd_linalg.expm_symmetric(tangent_vectors + reference_point_logm)[0]
    ...
    def test_backward(self, n_matrices, n_features, cond, device, dtype, generator):
        ...
        Y_manual = log_euclidean.LogEuclideanLogCoordinates(X_manual, G_manual)
        Y_auto = log_euclidean.log_euclidean_log_coordinates(X_auto, G_auto)
...
class TestLogEuclideanExpCoordinates:
    """
    ...
    def test_forward_shape(
        ...
        X_auto = log_euclidean.log_euclidean_exp_coordinates(data, reference_point)
        X_manual = log_euclidean.LogEuclideanExpCoordinates(data, reference_point)
        ...
        assert_close(X_auto, X_manual)
        assert_close(
            log_euclidean.log_euclidean_log_coordinates(X_auto, reference_point),
            data,
            atol=1e-4,
            rtol=1e-5,
        )
        assert_close(
            log_euclidean.log_euclidean_log_coordinates(X_manual, reference_point),
            data,
            atol=1e-4,
            rtol=1e-5,
        )
    ...
    def test_self_exp(self, n_features, cond, device, dtype, generator):
        ...
        X_manual = log_euclidean.LogEuclideanExpCoordinates(zero_vec, reference_point)
        X_auto = log_euclidean.log_euclidean_exp_coordinates(zero_vec, reference_point)
    ...
    def test_general_case(self, n_matrices, n_features, cond, device, dtype, generator):
        ...
        tangent_vectors = spd_linalg.sym_matrix_to_coordinates(
            spd_linalg.logm_SPD(data)[0] - reference_point_logm
        )

        X_manual = log_euclidean.LogEuclideanExpCoordinates(
            tangent_vectors, reference_point
        )
        X_auto = log_euclidean.log_euclidean_exp_coordinates(
            tangent_vectors, reference_point
        )
    ...
    def test_backward(self, n_matrices, n_features, cond, device, dtype, generator):
        ...
        Y_manual = log_euclidean.LogEuclideanExpCoordinates(X_manual, G_manual)
        Y_auto = log_euclidean.log_euclidean_exp_coordinates(X_auto, G_auto)
